...
const Hero = () => {
  return (
    ...
    <div className="w-full md:min-h-screen md:h-[915px] h-[700px] bg-[url('/assets/images/bg-imag.jpg')] bg-cover md:bg-center bg-no-repeat relative bg-position-[center_right_-11rem] 2xl:container 2xl:mx-auto ">
